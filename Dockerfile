...
RUN apt clean
RUN apt update -y && DEBIAN_FRONTEND=noninteractive apt-get install -y gcc g++ make git vi autoconf libssl-dev zlib1g-dev curl libcurl4-gnutls-dev libcrypto++-dev libzstd-dev libtool pkg-config
